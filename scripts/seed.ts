...
const laptops = [
  ...
  { name: "Strawberry",   description: "Backup laptop; used when primary units are unavailable",                   serial: "LP-STR-001", date: "2019-03-22", cond: "Impaired", status: "Unavailable (In Repairs)"  },
];
