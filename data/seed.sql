...
INSERT INTO equipment (id, name, description, serial_number, condition, quantity, location, status) VALUES (6, 'Strawberry', 'Backup laptop; used when primary units are unavailable', 'LP-STR-001', 'Impaired', 1, 'Media Room', 'In Repairs');
